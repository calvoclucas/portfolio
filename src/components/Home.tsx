...
export default function Home() {
  return (
<section id="inicio" className="w-full flex flex-col md:flex-row items-center h-screen px-6 md:px-12 bg-white mt-28">
  ...
  Hola! Soy Lucas Calvo Coltro
      ...
      <p className="text-gray-500 mb-8">
        Técnico en Programación y estudiante de Ingeniería en Sistemas, apasionado por desarrollo. Me gusta combinar creatividad y tecnología para crear aplicaciones funcionales y atractivas.
      </p>

      <div className="flex gap-4">
        <button className="bg-purple-600 text-white px-6 py-3 hover:bg-purple-700 transition flex items-center gap-2">
